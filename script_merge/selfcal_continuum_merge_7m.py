...
outname = 'SgrB2_selfcal_full_TCTE7m_selfcal5_ampphase'
os.system('rm -rf ' + outname + "*")
myimagebase = outname
...
cleanimage = 'SgrB2_selfcal_full_TCTE7m_selfcal4_ampphase.image'
ia.open(cleanimage)
...
outname = 'SgrB2_selfcal_full_TCTE7m_selfcal4_ampphase_deeper_mask2.5mJy'
os.system('rm -rf ' + outname + "*")
myimagebase = outname
tclean(vis=selfcal4vis,
       imagename=myimagebase,
...
for robust in (2,1,0,-1,-2):
    outname = 'SgrB2_selfcal_full_TCTE7m_selfcal4_ampphase_robust{0}'.format(robust)
    os.system('rm -rf ' + outname + "*")
    myimagebase = outname
    tclean(vis=selfcal4vis,
           imagename=myimagebase,
