...
pl.legend(loc='best')
pl.loglog()
pl.axis([1e3,1e5,0.1,10])

pl.figure(2).clf()
pl.hist(luminosities_H[flux_sgrb2_H>0.5*u.mJy], bins=np.logspace(3,5,21))
pl.hist(luminosities_S[flux_sgrb2_S>0.5*u.mJy], bins=np.logspace(3,5,21))
pl.semilogx()
