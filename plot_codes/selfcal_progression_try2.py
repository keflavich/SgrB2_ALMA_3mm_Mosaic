...
rsc6tt = fits.open(paths.mergepath('continuum/SgrB2_selfcal_full_TCTE7m_try2_selfcal6_ampphase_deeper_mask1.5mJy.residual.tt0.fits'))
...
for name, ((ra1,dec1),(ra2,dec2)),(vmin,vmax) in [
    ...
    for ii, (fh,rfh) in enumerate(zip(imlist,
        ...
        im = ax.imshow(cutout_im.data*1e3, cmap='gray',
                       ...
                       origin='lower',)
        ax2 = fig.add_subplot(2,len(imlist),ii+len(imlist)+1, projection=cutout_im.wcs)
