...
VLA data in Figure \ref{fig:coreson20cm}, the 3 mm continuum reveals long
...
By contrast, Sgr B2 Far North does not contain any ionized emission.
It contains fewer total sources, but these sources clearly trace the
edge of an expanding bubble previously noted by \citet{de-Vicente1997a}.
