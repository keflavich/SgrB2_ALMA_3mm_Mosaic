...
flux density distribution follows a powerlaw with slope $\alpha=1.72\pm0.06$
\citep{Clauset2007a}, far shallower than the $\alpha\sim2.35$ expected for a
normal IMF.
...
fit shown.  The fitted powerlaw is an excellent fit to the data, but is far
shallower than the IMF slope, with $\alpha=1.72\pm0.06$.}
{fig:fluxhist}{1}{15cm}
