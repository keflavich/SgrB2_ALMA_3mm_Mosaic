...
detections at 3 mm, and we do not presently have the capability to distinguish
...
{\color{red}TODO: I don't know why; we have effectively the same source counts
(though they have 1 more in South than I do) but significantly different
inferred masses.}
...
to progressively increasing star formation along the dust ridge.  Cloud-cloud
collision models assume that independent clouds on different orbits are
interacting.  By contrast with both of these models, the expanding shells are
driven by feedback from a previously formed generation of high-mass stars.

There is plenty of evidence of expanding shells in Sgr B2, but less clear
evidence that the shells are primary sites of star formation.
...
other clusters and the distributed star forming population.  This difference
implies that Sgr B2 M is older than Sgr B2 N and older than the distributed
population.  Along the Sgr B2 DS ridge, there are no \hii regions, but there
are $\sim100$ high-mass protostars, implying a near-simultaneous formation
time.

The relative ages suggest two possibilities for the formation history of the
region.  If we take the ages at face value, Sgr B2 M collapse to form stars in
a first event, then sometime later the DS ridge collapsed in a separate star
forming event.  A second possibility is that the overall collapse of both Sgr
B2 M and DS began at the same time, but the Sgr B2 M region was denser and had
a shorter dynamical time.  Our catalog does not allow us to distinguish these
possibilities.  However, the latter scenario would predict that the cloud
should be in a state of global collapse, with the least dense regions collapsing
most slowly.  This collapse may leave detectable kinematic signatures in the
dense gas.
