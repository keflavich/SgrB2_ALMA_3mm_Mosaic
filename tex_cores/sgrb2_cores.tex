...
density, not all regions of high column density ($N(\hh)>10^{23}$ \persc)
...
and compact sources in the lower half of the image.  The other massive
protocluster, Sgr B2 N, is in the center.  Imaging artifacts are evident at the
1-2 mJy bm$^{-1}$ level.
{\color{red}NOTE: The figure has been updated but the caption has not; the colors
are presently wrong!}
}
