...
changes the gas's ability to cool.}. 
...
\Figure{figures/cores_on_SCUBA_column_saturated.png}
...
{fig:coresonscubacol}{1}{\textwidth}
...
% core_local_brightness
\Figure{figures/compare_brick_sgrb2_colPDF.png}
...
line.}
{fig:bricksgrb2colcompare}{1}{\textwidth}
...
While there is an apparent column density threshold required for high-mass stars
to form, that threshold clearly forms only a necessary, not a sufficient, condition
for star formation.  Figure \ref{fig:coldistributionwithoutstarformation} shows
that there is abundant material within our observed region at $N>1$ g \persc
that is not associated with ongoing high-mass star formation.

% nonstarforming_regions.py
\Figure{figures/column_density_distribution_with_and_without_SF.png}
...
{fig:coldistributionwithoutstarformation}{1}{\textwidth}
