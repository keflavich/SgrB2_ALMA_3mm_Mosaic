...
We observe a threshold for high-mass star formation that is substantially higher
than the local threshold for star formation, implying either that high-mass star
formation requires a higher column density or that the star formation threshold
in the CMZ is higher than locally.
...
`conservative' and `aggressive' in Figure \ref{fig:fluxhist}).  Both of
