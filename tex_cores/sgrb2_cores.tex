...
\ref{fig:overview}]{Schmiedeke2016a} and,
at a much lower level, Clouds C, D, and E \citep[][Walker et al, in
...
unless Sgr B2 DS proves to be the edge of a shell, it appears that these shells
do not provide a sufficient condition to drive star forming bursts.
...
may leave detectable kinematic signatures (e.g., self-absorption in moderately
optically thick lines) in the dense gas.
