...
(triggering)
There is extended ionized emission in Sgr B2 Deep South that appears
to be a bubble surrounded by the millimeter continuum sources.
While this region looks like a normal, if a bit lumpy, \hii region
in the 12\arcsec resolution 20 cm VLA data in Figure \ref{fig:coreson20cm},
the 3 mm continuum reveals long filamentary features reminiscent of the
Galactic center arched filaments, hinting that they 
