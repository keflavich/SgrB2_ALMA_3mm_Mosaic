...
if(mystep in thesteps):
  ...
  flagdata(vis = 'uid___A002_Xa4dcb9_Xbad.ms',
    mode = 'manual',
    spw = '1~24',
    autocorr = T,
    flagbackup = F)
  ...
  flagcmd(vis = 'uid___A002_Xa4dcb9_Xbad.ms',
    inpmode = 'table',
    useapplied = True,
    action = 'plot',
    plotfile = 'uid___A002_Xa4dcb9_Xbad.ms.flagcmd.png')
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xa4dcb9_Xbad.ms.wvr') 
  
  os.system('rm -rf uid___A002_Xa4dcb9_Xbad.ms.wvrgcal') 
  
  mylogfile = casalog.logfile()
  casalog.setlogfile('uid___A002_Xa4dcb9_Xbad.ms.wvrgcal')
  
  wvrgcal(vis = 'uid___A002_Xa4dcb9_Xbad.ms',
    caltable = 'uid___A002_Xa4dcb9_Xbad.ms.wvr',
    spw = [17, 19, 21, 23],
    smooth = '6.048s',
    toffset = 0,
  ...
  if applyonly != True: aU.plotWVRSolutions(caltable='uid___A002_Xa4dcb9_Xbad.ms.wvr', spw='17', antenna='DA55',
    yrange=[-199,199],subplot=22, interactive=False,
    figfile='uid___A002_Xa4dcb9_Xbad.ms.wvr.plots/uid___A002_Xa4dcb9_Xbad.ms.wvr') 
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xa4dcb9_Xbad.ms.tsys') 
  gencal(vis = 'uid___A002_Xa4dcb9_Xbad.ms',
    caltable = 'uid___A002_Xa4dcb9_Xbad.ms.tsys',
    caltype = 'tsys')
 
#  gencal(vis = 'uid___A002_Xa4dcb9_Xbad.ms',
#    caltable = 'uid___A002_Xa4dcb9_Xbad.ms.tsys.forThomas',
#    caltype = 'tsys')
 
 
  # Flagging edge channels
  
  flagdata(vis = 'uid___A002_Xa4dcb9_Xbad.ms.tsys',
    mode = 'manual',
    spw = '9:0~3;124~127,11:0~3;124~127,13:0~3;124~127,15:0~3;124~127',
    flagbackup = F)


  # Flagging in tsys table
  
  flagdata(vis = 'uid___A002_Xa4dcb9_Xbad.ms.tsys', # Tsys temp high
    mode = 'manual',
    spw='9,11',
    antenna='DA41',
    timerange='04:12:00~04:51:40',
    flagbackup=F)

  flagdata(vis = 'uid___A002_Xa4dcb9_Xbad.ms.tsys', # spike
    mode = 'manual',
    spw='9:37~41',     #'9:91.63~91.7GHz',
    antenna='', #'DA42, DA43, DA44, DA45, DA46, DA47, DA54, DA55, DA64, DV05, DV07, DV16, DV25',
    flagbackup=F)       

  flagdata(vis = 'uid___A002_Xa4dcb9_Xbad.ms.tsys', # small oscillation at edge of spw
    mode = 'manual',
    spw='11:0~11',  #'11:90.3~90.5GHz',
    antenna='DA51,DA52,DA58,DA50,DV14,DV16,DV21',
    flagbackup=F)

  flagdata(vis = 'uid___A002_Xa4dcb9_Xbad.ms.tsys', # big oscillation at edge of spw
    mode = 'manual',
    spw='11:0~23', #'11:90.1~90.5GHz',
    antenna='DV03',
    flagbackup=F)
 
  flagdata(vis = 'uid___A002_Xa4dcb9_Xbad.ms.tsys', # strong oscillation at edge of spw
    mode = 'manual',
    spw='13:0~27', #'13:100.4~100.8GHz',
    antenna='DV18',
    flagbackup=F)       

  flagdata(vis = 'uid___A002_Xa4dcb9_Xbad.ms.tsys', # small oscillation at edge of spw 
    mode = 'manual',
    spw='13:0~8', #'13:100.4~100.5GHz',
    antenna='DA43,DA44,DA45, DA46, DA49, DA50, DA51, DA52, DA54, DA55, DA57, DA58, DV05, DV11, DV16, DV21, DV22, DV23, DV24, DV25',
    flagbackup=F)       

  flagdata(vis = 'uid___A002_Xa4dcb9_Xbad.ms.tsys', # small oscillation at edge of spw
    mode = 'manual',
    spw='15:0~10', #'15:102.2~102.4GHz',
    antenna='DA51,DA52,DA54,DA54,DA55,DV03',
    flagbackup=F)
  
  if applyonly != True: aU.plotbandpass(caltable='uid___A002_Xa4dcb9_Xbad.ms.tsys', overlay='time', 
    ...
    field='', figfile='uid___A002_Xa4dcb9_Xbad.ms.tsys.plots.overlayTime/uid___A002_Xa4dcb9_Xbad.ms.tsys') 
  
  
  if applyonly != True: es.checkCalTable('uid___A002_Xa4dcb9_Xbad.ms.tsys', msName='uid___A002_Xa4dcb9_Xbad.ms', interactive=False) 
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xa4dcb9_Xbad.ms.antpos') 
  gencal(vis = 'uid___A002_Xa4dcb9_Xbad.ms',
    caltable = 'uid___A002_Xa4dcb9_Xbad.ms.antpos',
    caltype = 'antpos',
...
if(mystep in thesteps):
  ...
  if applyonly != True: es.getCalWeightStats('uid___A002_Xa4dcb9_Xbad.ms') 
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xa4dcb9_Xbad.ms.split') 
  os.system('rm -rf uid___A002_Xa4dcb9_Xbad.ms.split.flagversions') 
  split(vis = 'uid___A002_Xa4dcb9_Xbad.ms',
    outputvis = 'uid___A002_Xa4dcb9_Xbad.ms.split',
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xa4dcb9_Xbad.ms.split.listobs')
  listobs(vis = 'uid___A002_Xa4dcb9_Xbad.ms.split',
    listfile = 'uid___A002_Xa4dcb9_Xbad.ms.split.listobs')
  
  tb.open('uid___A002_Xa4dcb9_Xbad.ms.split/POINTING', nomodify = False)
  a = tb.rownumbers()
  tb.removerows(a)
  tb.close()
  
  if not os.path.exists('uid___A002_Xa4dcb9_Xbad.ms.split.flagversions/Original.flags'):
    flagmanager(vis = 'uid___A002_Xa4dcb9_Xbad.ms.split',
      mode = 'save',
...
if(mystep in thesteps):
  ...
  flagdata(vis = 'uid___A002_Xa4dcb9_Xbad.ms.split',
    mode = 'shadow',
    flagbackup = F)
...
if(mystep in thesteps):
  ...
  setjy(vis = 'uid___A002_Xa4dcb9_Xbad.ms.split',
    field = '1', # Titan
    spw = '0,1,2,3',
    standard = 'Butler-JPL-Horizons 2012')
  
  if applyonly != True:
    os.system('rm -rf uid___A002_Xa4dcb9_Xbad.ms.split.setjy.field*.png') 
    for i in ['1']:
      plotms(vis = 'uid___A002_Xa4dcb9_Xbad.ms.split',
        xaxis = 'uvdist',
        yaxis = 'amp',
        ydatacolumn = 'model',
        field = str(i),
        ...
        avgchannel = '9999',
        coloraxis = 'spw',
        plotfile = 'uid___A002_Xa4dcb9_Xbad.ms.split.setjy.field'+i+'.png')
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xa4dcb9_Xbad.ms.split.ap_pre_bandpass') 
  
  gaincal(vis = 'uid___A002_Xa4dcb9_Xbad.ms.split',
    caltable = 'uid___A002_Xa4dcb9_Xbad.ms.split.ap_pre_bandpass',
    field = '0', # J1733-1304
  ...
  if applyonly != True: es.checkCalTable('uid___A002_Xa4dcb9_Xbad.ms.split.ap_pre_bandpass', msName='uid___A002_Xa4dcb9_Xbad.ms.split', interactive=False) 
  
  os.system('rm -rf uid___A002_Xa4dcb9_Xbad.ms.split.bandpass') 
  bandpass(vis = 'uid___A002_Xa4dcb9_Xbad.ms.split',
    caltable = 'uid___A002_Xa4dcb9_Xbad.ms.split.bandpass',
    field = '0', # J1733-1304
    scan = '1,2,4',
    solint = 'inf',
    combine = 'scan',
    ...
    solnorm = True,
    bandtype = 'B',
    gaintable = 'uid___A002_Xa4dcb9_Xbad.ms.split.ap_pre_bandpass')
  
  os.system('rm -rf uid___A002_Xa4dcb9_Xbad.ms.split.bandpass_smooth20ch') 
  
  bandpass(vis = 'uid___A002_Xa4dcb9_Xbad.ms.split',
    caltable = 'uid___A002_Xa4dcb9_Xbad.ms.split.bandpass_smooth20ch',
    field = '0', # J1733-1304
    scan = '1,2,4',
    solint = 'inf,20ch',
    combine = 'scan',
  ...
  if applyonly != True: es.checkCalTable('uid___A002_Xa4dcb9_Xbad.ms.split.bandpass_smooth20ch', msName='uid___A002_Xa4dcb9_Xbad.ms.split', interactive=False) 
  
  if applyonly != True: es.checkCalTable('uid___A002_Xa4dcb9_Xbad.ms.split.bandpass', msName='uid___A002_Xa4dcb9_Xbad.ms.split', interactive=False) 
...
if(mystep in thesteps):
  ...
  delmod('uid___A002_Xa4dcb9_Xbad.ms.split',field='2')
  
  os.system('rm -rf uid___A002_Xa4dcb9_Xbad.ms.split.phase_short_int') 
  gaincal(vis = 'uid___A002_Xa4dcb9_Xbad.ms.split',
    caltable = 'uid___A002_Xa4dcb9_Xbad.ms.split.phase_short_int',
    field = '1', # Titan
    selectdata = T,
    ...
    gaintable = 'uid___A002_Xa4dcb9_Xbad.ms.split.bandpass_smooth20ch')
  ...
  if applyonly != True: es.checkCalTable('uid___A002_Xa4dcb9_Xbad.ms.split.phase_short_int', msName='uid___A002_Xa4dcb9_Xbad.ms.split', interactive=False) 
  
  os.system('rm -rf uid___A002_Xa4dcb9_Xbad.ms.split.ampli_short_inf') 
  gaincal(vis = 'uid___A002_Xa4dcb9_Xbad.ms.split',
    caltable = 'uid___A002_Xa4dcb9_Xbad.ms.split.ampli_short_inf',
    ...
    gaintype = 'G',
    calmode = 'ap',
    gaintable = ['uid___A002_Xa4dcb9_Xbad.ms.split.bandpass_smooth20ch', 'uid___A002_Xa4dcb9_Xbad.ms.split.phase_short_int'])
  
  if applyonly != True: es.checkCalTable('uid___A002_Xa4dcb9_Xbad.ms.split.ampli_short_inf', msName='uid___A002_Xa4dcb9_Xbad.ms.split', interactive=False) 
  
  os.system('rm -rf uid___A002_Xa4dcb9_Xbad.ms.split.flux_short_inf') 
  os.system('rm -rf uid___A002_Xa4dcb9_Xbad.ms.split.fluxscale') 
  mylogfile = casalog.logfile()
  casalog.setlogfile('uid___A002_Xa4dcb9_Xbad.ms.split.fluxscale')
  
  fluxscaleDict = fluxscale(vis = 'uid___A002_Xa4dcb9_Xbad.ms.split',
    caltable = 'uid___A002_Xa4dcb9_Xbad.ms.split.ampli_short_inf',
    fluxtable = 'uid___A002_Xa4dcb9_Xbad.ms.split.flux_short_inf',
    reference = '1') # Titan
  
  casalog.setlogfile(mylogfile)
  
  if applyonly != True: es.fluxscale2(caltable = 'uid___A002_Xa4dcb9_Xbad.ms.split.ampli_short_inf', removeOutliers=True, msName='uid___A002_Xa4dcb9_Xbad.ms', writeToFile=True, preavg=10000)
  
  f = open('uid___A002_Xa4dcb9_Xbad.ms.split.fluxscale')
  fc = f.readlines()
  f.close()
  ...
  os.system('rm -rf uid___A002_Xa4dcb9_Xbad.ms.split.phase_int') 
  gaincal(vis = 'uid___A002_Xa4dcb9_Xbad.ms.split',
    caltable = 'uid___A002_Xa4dcb9_Xbad.ms.split.phase_int',
    field = '0,1,2', # J1733-1304,Titan,J1752-2956
    solint = 'int',
    refant = 'DA55',
    gaintype = 'G',
  ...
  if applyonly != True: es.checkCalTable('uid___A002_Xa4dcb9_Xbad.ms.split.phase_int', msName='uid___A002_Xa4dcb9_Xbad.ms.split', interactive=False) 
  
  os.system('rm -rf uid___A002_Xa4dcb9_Xbad.ms.split.flux_inf') 
  gaincal(vis = 'uid___A002_Xa4dcb9_Xbad.ms.split',
    caltable = 'uid___A002_Xa4dcb9_Xbad.ms.split.flux_inf',
    field = '0,1,2', # J1733-1304,Titan,J1752-2956
    solint = 'inf',
    refant = 'DA55',
    gaintype = 'G',
    calmode = 'ap',
    gaintable = ['uid___A002_Xa4dcb9_Xbad.ms.split.bandpass_smooth20ch', 'uid___A002_Xa4dcb9_Xbad.ms.split.phase_int'])
  
  if applyonly != True: es.checkCalTable('uid___A002_Xa4dcb9_Xbad.ms.split.flux_inf', msName='uid___A002_Xa4dcb9_Xbad.ms.split', interactive=False) 
  
  os.system('rm -rf uid___A002_Xa4dcb9_Xbad.ms.split.phase_inf') 
  gaincal(vis = 'uid___A002_Xa4dcb9_Xbad.ms.split',
    caltable = 'uid___A002_Xa4dcb9_Xbad.ms.split.phase_inf',
    field = '0,1,2', # J1733-1304,Titan,J1752-2956
    solint = 'inf',
    refant = 'DA55',
    gaintype = 'G',
  ...
  if applyonly != True: es.checkCalTable('uid___A002_Xa4dcb9_Xbad.ms.split.phase_inf', msName='uid___A002_Xa4dcb9_Xbad.ms.split', interactive=False) 
...
if(mystep in thesteps):
  ...
  for i in ['0', '1']: # J1733-1304,Titan
    applycal(vis = 'uid___A002_Xa4dcb9_Xbad.ms.split',
      field = str(i),
      gaintable = ['uid___A002_Xa4dcb9_Xbad.ms.split.bandpass_smooth20ch', 'uid___A002_Xa4dcb9_Xbad.ms.split.phase_int', 'uid___A002_Xa4dcb9_Xbad.ms.split.flux_inf'],
      gainfield = ['', i, i],
      interp = 'linear,linear',
      calwt = T,
      flagbackup = F)
  ...
  applycal(vis = 'uid___A002_Xa4dcb9_Xbad.ms.split',
    field = '2,3~151', # SgrB2
    gaintable = ['uid___A002_Xa4dcb9_Xbad.ms.split.bandpass_smooth20ch', 'uid___A002_Xa4dcb9_Xbad.ms.split.phase_inf', 'uid___A002_Xa4dcb9_Xbad.ms.split.flux_inf'],
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xa4dcb9_Xbad.ms.split.cal') 
  os.system('rm -rf uid___A002_Xa4dcb9_Xbad.ms.split.cal.flagversions') 
  split(vis = 'uid___A002_Xa4dcb9_Xbad.ms.split',
    outputvis = 'uid___A002_Xa4dcb9_Xbad.ms.split.cal',
    datacolumn = 'corrected',
    keepflags = T)
...
# Flag the residual atmospheric lines in the target data.
  ...
  flagdata(vis = 'uid___A002_Xa4dcb9_Xbad.ms.split.cal', mode = 'manual', spw = '2:5193~5718', field = '3~151', flagbackup = F)
...
if(mystep in thesteps):
  ...
  flagmanager(vis = 'uid___A002_Xa4dcb9_Xbad.ms.split.cal',
    mode = 'save',
    versionname = 'AfterApplycal')
  
  

#es.generateQA2Report(ms1='uid___A002_Xa4dcb9_Xbad.ms',refAnt='DA55',target='5',phase_cal='2')
