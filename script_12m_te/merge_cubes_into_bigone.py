...
def make_spw_cube(spw='spw{0}', spwnum=0, fntemplate='full_SgrB2_12m',
    ...
    if not os.path.exists(big_filename):
        ...
        with open(big_filename, 'rb+') as fobj:
             ...
             # Also, /8 returns a float in python3 so we have to force int
             fobj.seek(int(len(header.tostring()) +
