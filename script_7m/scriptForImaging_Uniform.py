...
# Spw 0, HNC (K=3)
os.system('rm -rf SgrB2_a_03_7M.HNC.uniform.*')
#default(clean)
...
#default(clean)
clean(vis = 'SgrB2_a_03_7M.cal.contsub',
  imagename = 'SgrB2_a_03_7M.CH3CN_5-4_3.uniform',
  field = '0~52', # SgrB2
  spw = '0,4,8,12',
...
#default(clean)
clean(vis = 'SgrB2_a_03_7M.cal.contsub',
  imagename = 'SgrB2_a_03_7M.HCOp.uniform',
  field = '0~52', # SgrB2
  spw = '1,5,9,13',
...
#default(clean)
clean(vis = 'SgrB2_a_03_7M.cal.contsub',
  imagename = 'SgrB2_a_03_7M.HCN.uniform',
  field = '0~52', # SgrB2
  spw = '1,5,9,13',
...
#default(clean)
clean(vis = 'SgrB2_a_03_7M.cal.contsub',
  imagename = 'SgrB2_a_03_7M.H2CO615-616.uniform',
  field = '0~52', # SgrB2
  spw = '2,6,10,14',
...
#default(clean)
clean(vis = 'SgrB2_a_03_7M.cal.contsub',
  imagename = 'SgrB2_a_03_7M.H2CS303-202.uniform',
  field = '0~52', # SgrB2
  spw = '3,7,11,15',
...
#default(clean)
clean(vis = 'SgrB2_a_03_7M.cal.contsub',
  imagename = 'SgrB2_a_03_7M.H2CS321-220.uniform',
  field = '0~52', # SgrB2
  spw = '3,7,11,15',
...
clean(vis = 'SgrB2_a_03_7M.cal',
  imagename = 'SgrB2_a_03_7M.CFp.uniform',
  field = '0~52', # SgrB2
  spw = '3,7,11,15',
...
myimages = ['SgrB2_a_03_7M.HNC.uniform', 'SgrB2_a_03_7M.CH3CN_5-4_3.uniform',
            ...
            'SgrB2_a_03_7M.lowres.uniform.spw1',
            'SgrB2_a_03_7M.lowres.uniform.spw2',
            'SgrB2_a_03_7M.lowres.uniform.spw3',
           ]
